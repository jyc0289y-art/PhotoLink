...
export function WebGLCanvas({ image, params, showOriginal, onEngineReady }: Props) {
  ...
  useEffect(() => {
    ...
    // Apply rotation/flip to create the source image
  ...
  return (
    <div ref={containerRef} className="flex-1 flex items-center justify-center overflow-hidden bg-surface relative">
      {!image && (
